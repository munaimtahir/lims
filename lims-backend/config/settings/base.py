...
MIDDLEWARE = [
    ...
    "apps.audit.middleware.AuditLoggingMiddleware",  # Audit logging middleware
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": config("LIMS_DB_PASSWORD", default=""),
...
# Media files (served by Caddy in production; /app/media in container)
MEDIA_URL = "/media/"
MEDIA_ROOT = os.getenv("MEDIA_ROOT", "/app/media")

# Uploads root (bind-mounted in Docker)
...
REST_FRAMEWORK = {
    ...
    # Disable CSRF for API endpoints (DRF handles authentication via JWT)
