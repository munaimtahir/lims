...
class TestUserModel:
    ...
    def test_user_role_properties(
        self, admin_user, receptionist_user, lab_technician_user,
        pathologist_user, manager_user, phlebotomist_user
    ):
...
class TestUserViewSet:
    ...
    def test_list_users_admin(self, authenticated_client, admin_user, receptionist_user):
    ...
    def test_create_user_admin(self, authenticated_client):
        ...
        response = authenticated_client.post('/api/v1/auth/users/', {
            'username': 'newuser',
    ...
    def test_update_user_admin(self, authenticated_client, receptionist_user):
        ...
        response = authenticated_client.patch(f'/api/v1/auth/users/{receptionist_user.id}/', {
    ...
    def test_change_password(self, authenticated_client, admin_user):
        ...
        response = authenticated_client.post(f'/api/v1/auth/users/{admin_user.id}/change_password/', {
