...
class TestResultSerializer(serializers.ModelSerializer):
    ...
    """
    parameter_name = serializers.CharField(source='test_parameter.parameter_name', read_only=True)
    ...
    class Meta:
        model = TestResult
        fields = [
            'id', 'order_item', 'test_parameter', 'parameter_name', 'unit',
            'result_value', 'flag', 'remarks',
            'entered_by', 'entered_by_name', 'entered_at',
            'verified_by', 'verified_by_name', 'verified_at'
        ]
        read_only_fields = ['flag', 'entered_by', 'entered_at', 'verified_by', 'verified_at']
