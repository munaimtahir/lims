    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={
                ...
                'indexes': [
                    models.Index(fields=['parameter_id'], name='parameters_param_id_idx'),
        ...
        migrations.AddField(model_name='parameterquicktext', name='parameter_temp', field=models.CharField(max_length=100, null=True)),
        migrations.AddField(model_name='parameterreferencerange', name='parameter_temp', field=models.CharField(max_length=100, null=True)),
        migrations.AddField(model_name='testparameterlink', name='parameter_temp', field=models.CharField(max_length=100, null=True)),

        # 4. Copy Data
        migrations.RunPython(copy_parameter_ids, migrations.RunPython.noop),

        # 5. Remove constraints/indexes from children
        migrations.AlterUniqueTogether(name='parameterquicktext', unique_together=set()),
        ...
        migrations.RenameField(model_name='parameterquicktext', old_name='parameter_temp', new_name='parameter'),
        migrations.RenameField(model_name='parameterreferencerange', old_name='parameter_temp', new_name='parameter'),
        migrations.RenameField(model_name='testparameterlink', old_name='parameter_temp', new_name='parameter'),

        migrations.AlterField(
            model_name='parameterquicktext',
            name='parameter',
            field=models.ForeignKey(to='laboratory.parameter', on_delete=django.db.models.deletion.CASCADE, related_name='quick_texts'),
        ),
        migrations.AlterField(
            model_name='parameterreferencerange',
            name='parameter',
            field=models.ForeignKey(to='laboratory.parameter', on_delete=django.db.models.deletion.CASCADE, related_name='legacy_reference_ranges'),
        ),
        migrations.AlterField(
            model_name='testparameterlink',
            name='parameter',
            field=models.ForeignKey(to='laboratory.parameter', on_delete=django.db.models.deletion.CASCADE, related_name='test_links'),
        ),
