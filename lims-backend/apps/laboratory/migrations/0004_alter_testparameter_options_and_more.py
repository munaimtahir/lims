    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                primary_key=True,
                serialize=False,
                validators=[apps.laboratory.models.validate_parameter_id],
            ),
        ),
        migrations.AlterField(
            model_name="parameter",
        ...
        migrations.AddIndex(
            model_name="parameter",
            index=models.Index(
                fields=["parameter_id"], name="parameters_paramet_612311_idx"
            ),
        ),
        ...
        migrations.AlterField(
            ...
            name="tests",
            field=models.ManyToManyField(related_name="panels", to="laboratory.test"),
        ),
        migrations.RemoveField(
            model_name="testparameter",
            name="unit",
