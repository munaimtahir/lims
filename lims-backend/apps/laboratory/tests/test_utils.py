...
class TestImportTestsFromExcel:
    ...
    def test_import_tests_sheet(self):
        ...
        ws.append(["test_id", "test_code", "legacy_test_code", "test_name", 
    ...
    def test_import_reference_ranges_sheet(self):
        ...
        ws.append(["test_id", "parameter_id", "gender", "age_min", "age_max", 
    ...
    def test_import_all_sheets_together(self):
        ...
        ws_tests.append(["test_id", "test_code", "legacy_test_code", "test_name", 
                        "category", "sample_type", "price", "turnaround_time"])
        ws_tests.append([1, "TEST1", "001", "Test One", "Hematology", "Blood", 100.00, 24])
        ...
        ws_ranges.append(["test_id", "parameter_id", "gender", "age_min", "age_max", 
                         "reference_min", "reference_max", "critical_low", "critical_high"])
    ...
    def test_import_handles_missing_parameter_for_range(self):
        ...
        ws.append(["test_id", "parameter_id", "gender", "age_min", "age_max", 
                  "reference_min", "reference_max", "critical_low", "critical_high"])
        ws.append([1, "p999", "Male", 18, 65, 10.0, 20.0, 5.0, 25.0])  # p999 doesn't exist
