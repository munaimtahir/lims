...
class TestParameterIdValidation:
    ...
    def test_valid_parameter_id_formats(self):
        ...
        for param_id in valid_ids:
            param = Parameter(parameter_id=param_id, parameter_name="Test Parameter")
            param.save()
    ...
    def test_uppercase_parameter_id_normalized(self):
        ...
        param = Parameter(parameter_id="P1", parameter_name="Test Parameter")
        param.save()
    ...
    def test_invalid_parameter_id_formats(self):
        ...
        for param_id in invalid_ids:
            with pytest.raises(ValidationError):
                param = Parameter(
                    parameter_id=param_id, parameter_name="Test Parameter"
                )
                param.save()
    ...
    def test_parameter_id_uniqueness(self):
        ...
        Parameter.objects.create(parameter_id="p1", parameter_name="First Parameter")

        # Trying to create another with same ID should fail
        with pytest.raises(Exception):  # IntegrityError
            Parameter.objects.create(
                parameter_id="p1", parameter_name="Second Parameter"
            )
...
class TestDryRunImport:
    ...
    def test_dry_run_full_workflow(self):
        ...
        ws_tests.append(
            [1, "HB", "001", "Hemoglobin Test", "Hematology", "Blood", 50.00, 24]
        )
