...
"""
import openpyxl
from .catalog_io import import_catalog_from_excel, export_catalog_workbook, CATALOG_COLUMNS
...
def generate_import_template():
    ...
    for sheet_name in ["Tests", "Parameters", "Mapping", "Panels", "PanelTests", "ReferenceRanges"]:
