...
class QCRulesService:
    ...
    def __init__(self, content_dir: str = None):
        ...
        if content_dir is None:
            ...
            content_dir = os.path.join(
                os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "../lims-content"
            )
    ...
    def check_reference_range(self, test_name: str, value: float) -> QCFlag | None:
    ...
    def check_critical_value(self, test_name: str, value: float) -> QCFlag | None:
    ...
    def check_delta(
        self, test_name: str, current_value: float, previous_value: float
    ) -> QCFlag | None:
    ...
    def validate_result(
        self, test_name: str, value: float, previous_value: float | None = None
    ) -> list[QCFlag]:
        """
