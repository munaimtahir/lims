...
class VoiceMapping:
    ...
    @staticmethod
    def extract_name(transcript: str) -> tuple[Optional[str], float]:
    ...
    @staticmethod
    def extract_age(transcript: str) -> tuple[Optional[int], float]:
    ...
    @staticmethod
    def extract_gender(transcript: str) -> tuple[Optional[str], float]:
    ...
    @staticmethod
    def extract_contact(transcript: str) -> tuple[Optional[str], float]:
    ...
    @staticmethod
    def extract_tests(transcript: str) -> tuple[Optional[str], float]:
        """Extract test names from transcript with confidence score."""
        transcript_lower = transcript.lower()
        
        # Common test names
        common_tests = [
            "cbc", "complete blood count", "glucose", "hba1c", 
            "lipid profile", "liver function", "kidney function",
            "urine", "stool", "x-ray", "ultrasound", "ecg"
        ]
