...
// ... (skipping to JSX) ...
            ...
            <div className={styles.formGroup}>
              ...
              <input
                type="text"
                value={patientFormData.whatsapp_number || ''}
                onChange={(e) => setPatientFormData({ ...patientFormData, whatsapp_number: e.target.value })}
                className={styles.input}
