...
show_summary() {
    ...
    log_info "  - Production: https://lims.alshifalab.pk:8012"
    log_info "  - API:        https://lims.alshifalab.pk:8012/api/v1/"
    log_info "  - Admin:      https://lims.alshifalab.pk:8012/admin/"
    log_info "  - Health:     https://lims.alshifalab.pk:8012/api/v1/health/"
    echo "" | tee -a "$DEPLOY_LOG"
